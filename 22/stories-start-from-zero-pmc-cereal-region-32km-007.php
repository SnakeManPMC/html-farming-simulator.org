...
<p>
2023-08-05T09:50:00Z Got those mod issues sorted out, used <a href="https://github.com/FSGModding/FSG_Mod_Assistant" target="_blank">Farm Sim Game (FSG) FS22 mod assistant</a> to check them out, I have newer version of few but then other mods was also spotted as updates available so I updated those. Now everything is up to date and I'm good to go.
</p>
...
<p>
Checked that autodrive MASTER dir xml config files were identical to savegame1's, they were, then took savegame1/ dir only backup just in case, can never be too careful especially when returning to FS22 after a long time away, cant remember shit how things work so I might break stuff <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2023-08-05T10:06:00Z Okay in-game and log checked for errors or warnings, none present, nice, now I'm finally ready to begin farming <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
In the beginning of course I'll have to get myself familiar of this farm, its been months since I played FS22 and as far as I recall this savegame was one of the oldest I played at that time, so my memory is from several other terrains as well, cant remember details on each and every one of those <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2023-08-05T10:20:00Z First walking around vehicles tour done in-game, I was shocked by the poor performance, it was low as 32FPS and up to peak 45FPS at some viewing directions, hmm this is odd, last time I played all my recollection is that it was basically 60FPS <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Why is the performance so fucking bad in FS22 v1.12? <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
If giants changed something in the graphics engine and now my 60FPS performance is dragged to basically 35FPS, that really fucking sucks. I don't want to start dropping details to improve performance just because giants messed up something in the graphics engine <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
This is extremely valuable info, such mod-set and savegame should be saved in 7-zip backup which could be used at any time to compare results after giants base game updates. I am so glad I still do have that <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2023-08-05T11:38:00Z Feeding time is over, back to debugging FS22 v1.12 performance <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Now I'm at loss, why does my existing savegame give such a bad performance, well obviously the vehicles but... humm I absolutely without a question remember that PMC Cereal Region 32km Start From Zero and all my other savegames with vehicles were rock solid 60FPS, or lets put it this way; at least not 30-40FPS performance! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2023-08-05T12:46:00Z Fuck, found the issue. PMC Cereal Region 32km with PMC mod-set on new farm manager game mode by the dealership when looking at N gives 45FPS performance! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
Continue reading 
<!--
<a href="stories-start-from-zero-pmc-cereal-region-32km-008.php">next page</a>, 
-->
<a href="stories-start-from-zero-pmc-cereal-region-32km.php">Start From Zero PMC Cereal Region 32km Home</a>, go back to <a href="stories-start-from-zero-pmc-cereal-region-32km-006.php">previous page</a>.
</p>
