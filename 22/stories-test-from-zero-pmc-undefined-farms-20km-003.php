...
Please read <a href="test-from-zero-pmc-undefined-farms-20km.php">Test From Zero PMC Undefined Farms 20km Homepage</a> for details.
	...
	<h2>2022-12-29 Own Land Soybeans</h2>

<p>
2022-12-29T11:18:00Z New farming day has started, woke up, did computer chores, did not care about cooking food yet just fired up PMC Gaming computer and now I'm ready to continue farming <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
So just 5k over my budget not to mention leaving me no money for seeds. Sigh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Oh man that sucks so bad, embarrassing to roll out such vehicles on 20.4km x 20.4km terrain... dude, what the hell? <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>

<p>
But I DON'T want to do any more contracts, been doing contracts for the past two frigging days already, now its time to work on our own land <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2022-12-29T11:52:00Z Purchased the "next re-calc" list of equipment, sigh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Oh well, this is truly now FS17 Cornbelt Start From Scratch alike starter setup <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Putting all the bitching and moaning to the side... I'm actually really excited to start harvesting my purchased sorghum F22 <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-29T12:04:00Z Started harvesting sorghum F22, manually GPS. <i>Edit: 2024-02-19, Start From Zero rules only mention field flipping as an rule breaking offence, but this kind of harvesting a crop from a field you just bought it extremely hand-wavey thing, I would say that this should be specified in the rules as offence, any kind of shady activity to make money is forbidden.</i>
</p>

<p>
Here we go, harvesting our own field, finally. Well OK this is purchased crop from the previous land owner, but still its now our land <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-29T12:16:00Z First 8k liters of sorghum dumped into farm bin silo <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-29T13:17:00Z Feeding time is over, okay lets see what the PMC Undefined Farms 20km weather is like. OK, still raining <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Felt mighty fine fertilizing my own fields <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Apr 1st in-game 0926hrs, soybeans planting season is here, lets get to work <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
First ever soybeans planting season (in this savegame) is over! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Aayeah unless I'm mistaken all the soybeans planting season work has been done now! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
May 1st in-game 0930hrs, soybeans are growing, green plants just sprung up. Nice, soon we'll have something to harvest <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
I'm going to harvest soybeans all four fields driving manually with GPS and let autodrive haul grain into the farm bin silo at the dealership. Dunno why, I just want to enjoy fruits of my labor in this first harvest of our very own crops <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Just awesome to harvest your own planted and cared for soybeans crop, so cool! <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Half way done <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Yeah buddy, first own land and fields soybeans harvest done! Farm grain bin silo has 125.3k liters <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-30T00:07:00Z Started fertilizing F20, manually GPS. Was planning on using courseplay but then I thought on the last minute that nah its so slow, I'll do faster with GPS <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Apr in-game 0748hrs, lets start seeding some soybeans <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-30T01:21:00Z Finished seeding soybeans F20. Hilarious to seed with fendt favorit 515c without front weight pulling that kverneland optima rs, tractor pushes and does wheelies so much <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Uah another planting season is done! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
2022-12-30T03:54:00Z Alarm went off for being awake for 17hrs, pfft, I'll continue farming! <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-test-from-zero-pmc-undefined-farms-20km-004.php">next page</a>, <a href="stories-test-from-zero-pmc-undefined-farms-20km.php">Test From Zero PMC Undefined Farms 20km Home</a>, go back to <a href="stories-test-from-zero-pmc-undefined-farms-20km-002.php">previous page</a>.
</p>
