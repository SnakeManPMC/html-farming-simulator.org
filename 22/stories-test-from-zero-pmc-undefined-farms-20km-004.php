...
<p>
2022-12-30T13:18:00Z Purchased the above setup, now our combine harvester is "the best" <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Purchased diesel buy point to the dealership building, it was few thousand. Then I nastily drove lexion 8900 over neighbors growing field crops as it just doesn't fit through roads with 18.2m header attached, <i>nobody saw nuthing...</i> <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-30T13:56:00Z Feeding time is over, back to time accelerating. With my left hand I time accelerated to soybeans harvest season, crops are ready to go yeehaaw <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Ahh my good old friend, claas lexion 8900 with midwest durus 18.2m monster header, harvesting soybeans in cab view, gotta love it! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>

<p>
That massive wide 18.2m header when it cuts you cant even see the whole width from the cab view in normal 90 degree field of view (I think thats my FOV is setup cant remember). It is such an huge difference to the puny piece of crap topliner 4090 hts <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
Its funny that midwest durus 18.2m header is actually difficult to operate as you cannot see it in view all at once, you have to turn left and right to watch heh, also the mid part of the header blocks your view for GPS AB line so its easy to miss and overshoot. Needs some practice to become a professional big equipment operator <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Now I'm also using autodrive for the grain trailer tractor, it will automatically unload combine harvester when I put auger pipe out, then it takes trailer load to designated farm bin silo, just awesome. This starts to remind me of the good old Farming Simulator 17 (FS17) days when courseplay actually did a full harvest for you <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
Ugh messed up on third row, combine got full and I didn't pay attention so I drove into crop, not too long because I was watching the header cutting crop so I immediately hit... what I thought was S key to slow down / stop, unfortunately it was a miss, it was D which just turned combine right off the crop, oh well, mistakes were made <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-30T14:39:00Z Finished harvesting soybeans F21. Oh man what a joy it is to harvest in cab view with lexion 8900 + midwest durus 18.2m header, oh my oh my <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Before switching to F22 need to wait for grain trailer to return from the bin, this is now a good time to take a restroom break heh. It was funny when I came back from the restroom I just saw grain trailer tractor pulling out from combine which was now empty, autodrive combine unload works really nice, does the job when you're in the can <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-30T15:29:00Z Finished harvesting soybeans F23. Harvest season is done! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
I blatantly ignored neighbors privacy and parked big claas lexion 8900 with midwest durus 18.2m header into their field <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Jan in-game 0938hrs fields are now fully weeded, hopefully this time there wont be any glitch with the mapview soil composition weed page, not that the previous one did any damage I believe the yield was much the same as previously, 125.?k so give or take few hundred liters. <i>Edit: actually it was 125.3k so one hundred liters MORE than previously.</i>
</p>

<p>
Apr in-game 0916hrs soybeans planting season has arrived... and snow, huh what? <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Was a good call, after restroom break all the snow had melted, weeds were still in. Alright its time to do one final soybeans planting using fendt favorit 515c pulling kverneland optima rs planter, next year we have enough money to upgrade planting equipment <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-30T17:27:00Z Started seeding soybeans F23, manually GPS. On this field we run out of seeds, only 370 liters left at the start. Last field, last planting with this tractor and planter setup <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2022-12-30T17:32:00Z Kverneland optima rs ran out of seeds, off to the dealership. And I'm taking another restroom break, that water is just running through me <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
While spreading solid fertilizer using Kubota DSX-W Geospread I googled this vehicle <a href="https://ke.kubota-eu.com/agriculture/agricultural-tools/dsx-w-geospread/" target="_blank">ke.kubota-eu.com homepage for dsx-w</a> and just as I suspected... giants dsx-w is UNREALISTIC with its 10,000 liters hopper capacity! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
All other giants made spreader boxes like this have been in the 2-4k liter range, just like in real life that dsx-w is too, that raised suspicion and loy behold... frigging giants made this 10k liters which is twice the realistic size! Heck! I have now played three days with some mickey mouse garbage unrealistic bullcrap addon! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Man I feel betrayed by giants, I thought they were only using realistic numbers <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Sold Kubota M6-141 for 69.1k + dsx-w geospread unrealistic crap for 16.4k, budget now 172.9k <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Test From Zero savegame spawned the idea to create a real Start From Zero savegame to this and other huge <a href="pmc-terrains.php">PMC Terrains FS22</a>.
</p>
...
<p>
Back to <a href="stories-test-from-zero-pmc-undefined-farms-20km.php">Test From Zero PMC Undefined Farms 20km Home</a> or <a href="stories-test-from-zero-pmc-undefined-farms-20km-003.php">previous page</a>.
</p>
