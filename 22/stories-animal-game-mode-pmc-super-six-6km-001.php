...
<html lang="en">
<head>
<title>Animal Game-mode PMC Super Six 6km PMC Farming Simulator 22 Stories</title>
<LINK href="../css.css" rel=stylesheet type="text/css">
<META name="description" content="Animal Game-mode PMC Super Six 6km PMC Farming Simulator 22 Stories">
<meta charset="UTF-8">
...
<h1>Animal Game-mode PMC Super Six 6km Farming Simulator 22 Stories</h1>
...
<?php include("/var/www/include/section-start.php"); ?>
	<h2>2023-09-24 Getting Started</h2>

<p>
2023-09-24T08:46:00Z Created mod directory and savegame for "Animal Game-mode #1" which is first trial to get animal focused game-mode running. This is NOT a <a href="https://www.pmctactical.org/forum/viewtopic.php?f=76&t=22739" target="_blank">Start From Zero - Getting Started and Rules</a>, I want to avoid doing contracts as much as possible, in fact on the first mod directory bat file I didn't even have BetterContracts symlinked but decided to add it later as unfortunately I might have to do some emergency contracts. I created new career savegame on farm-manager game-mode, this gives no land, no vehicles but 1.5m in budget, also there are no other playing rules so I can use <a href="autodrive.php">FS22 AutoDrive</a>, <a href="courseplay.php">FS22 Courseplay</a> and GPS right from the beginning, also I could consider taking a bank loan but prefer not to as credit in-game as in real life is just loosing money, only losers take loans and credit.
</p>

<p>
So now I have nothing but 1.5m in cash, what do I buy first? Oh my... <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
Okay as the goal is to get animal farm going, <a href="guide-animals-cattle.php">cattle</a>, <a href="guide-animals-cows.php">cows</a>, <a href="guide-animals-pigs.php">pigs</a>, <a href="guide-animals-chickens.php">chickens</a>, <a href="guide-animals-sheep.php">sheep</a> and <a href="guide-animals-bees.php">bees</a>, that means I need basic set of equipment. However I don't think 1.5m budget allows me to buy all the <a href="guide-animals-placeables.php">animal placeables</a>, land and vehicles at once, or at least the vehicles part would be completely useless crap vehicles then. So I'm going to start with bees and chickens, bees require nothing but the placeable single purchase plus obviously autoloading trailer to haul <a href="guide-animals-product-honey.php">honey</a> to sell points, chickens require barley so I need small scale grain farming equipment and land with field on it, plus obviously farm yard for the bees and chickens.
</p>

<p>
With bees and chickens the goal is not to just time accelerate spam until enough honey and <a href="guide-animals-product-eggs.php">eggs</a> is produced, well I mean for chickens I have to harvest barley to feed them but bees require nothing, I could just spam bee hives and time accelerate 10 years while selling honey to make money but that is not realistic at all, so I will not do that, the farm has to start operating as soon as possible without any "lets make money by time accelerating" gimmicks. Main money maker would be chickens with eggs I think, so barley harvesting for chicken feed and yes then time accelerating. This is assuming 1.5m budget will not allow me to buy sheeps as well, at which point I would need grass mower and baling equipment as well, no the initial goal is bees & chickens to get started.
</p>
...
<li>combine harvester regular grain header</li>
<li>farm grain bin silo for barley</li>
<li>farmland farm yard for building placeables</li>
<li>farmland field for barley grain harvesting</li>
<li>grain trailer</li>
<li>seeder for barley (if direct drill then no need for cultivator)</li>
<li>tractor small</li>
<li>trailer autoloading strautmann 802 sek to haul animal product pallets for selling points</li>
</ul>
...
<p>
Okay enough planning, time for action, firing up FS22 (shut it down for some mod removal just prior) and starting to buy farmland and equipment, this will be fun <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2023-09-24T09:12:00Z Was checking out farm yards, didn't want to buy the ones which have buildings on them as that removes space and its kind of cheaty as the farmland price is not taking the buildings into consideration, if you buy such farmland and sell off the placeables, you make few hundred thousand dollars <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
So decided to buy farmland ID 2 which is nice and cozy without any buildings. Farmland ID cost me 20.1k. Then bought a field, oh man these fields are big and expensive in <a href="https://www.farming-simulator.org/22/pmc-super-six-6km.php">PMC Super Six 6km</a>, anyways I bought farmland ID 25 for 203.5k which has grass F13 in it. Okay now I have farm yard and field, budget now 1.276m, still plenty of money left.
</p>
...
<p>
Budget now 329.6k, okay, time to start driving my new equipment to the farm yard <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2023-09-24T10:02:00Z After being taken convey-all auger pipe and kuhn seeder to my farm yard and now returned to pickup next batch of implements... I already start to regret this distance from the dealership to my farm yard and not using store deliveries mod <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Whoah dude, three hour field work with this puny seeder? <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
2023-09-24T11:42:00Z Ran out of seeds <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
F13 in the early stages of this savegame, before getting better equipment, could be split into maybe 4 smaller sections, much more focused farming with shorter field work durations. Or maybe I just do one more soybeans planting, sell that grain off and then buy better equipment <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
While courseplay was running the tractor I already added FS22_storeDeliveries.zip to my Animal_Gamemode symlink bat file, once seeder is empty I'll restart FS22 with that mod and get some seeds and chicken feed delivered to my farm yard. I doubt autodrive files are available on this computer and don't really want to boot up PMC Gaming computer just for that, dunno.
</p>
...
<p>
2023-09-24T12:46:00Z Back seeding, time to finish this first field of barley! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
I just started my animal farm, only bees and one chicken coop not even half full of chickens, but the next step is of course sheeps and those require basic mower and baler, bare minimum so can do grass bales for sheeps. But once that is running, then its very easy going with chickens and sheep as they require so little maintenance, just dump in barley and bring in grass bales, all done <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2023-09-24T13:27:00Z Finished seeding barley F13, first field done! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
2023-09-24T14:20:00Z Sold and got 20.4k profit, my first animal farming profit, nice <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>

<p>
Apr in-game 0907hrs, chicken coop 1 now full 360 animals <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
May in-game 0910hrs, barley is still not ready, its 6/6 (forage) but chickens ran out of food, 0% food left, yikes! Alarm! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
Purchased one big bag of chicken feed (wheat) for 1.4k, delivery fee was 35. Then fed the chickens. Again <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Jun in-game 0925hrs, barley is ready to harvest and chickens are out of food again <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Additional field info shows potential harvest quantity 323.1k liters, oh my, my grain trailer is hmm 8k liters capacity I think, man if I have to haul THREE HUNDRED THOUSAND liters with it... yeah how many trips does that make <img src="../images/smileys/icon_eek.gif" alt="Smiley :bender-eyes:" loading="lazy">
</p>
...
<p>
Goodness gracious that ETA <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
Did three headland lands field work course, not that there are much objects near the field edge but yeah three headlands felt about right. Ooh maan, three hours of harvesting, this will be fun <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
2023-09-24T14:47:00Z First welger trailer is full, this is a joke... what was I thinking when buying 8k liter grain trailer? <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2023-09-24T14:55:00Z Chicken coop 1 is now 100% food status, now begins the long haul of that 3hrs 20min barley harvest <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
BTW there is fendt 700 vario and arcusin square bale collector for sale, tempting... tempting <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-002.php">next page</a> or go to <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>.
</p>

<p>
<a href="stories-animal-game-mode-pmc-super-six-6km.php" class="button">Animal Game-mode Home</a>
<a href="stories.php" class="button">FS22 Stories</a>
<a href="../index.php" class="button">PMC Farming Index</a>
</p>

<div class="pmc_farmsim1">
Where to find <b>Farming Simulator 22 (FS22) Story Content</b>, well here of course.
Read <b>PMC FS22 Animal Playing Guide And Tutorial</b> how to feed and take care of <b>FS22 Animals</b>.
You think <b>Taking Care of FS22 Chickens</b> is hard? Wait until you try <b>Tending FS22 Cattle</b> in a large scale!
What is the most profitable animal in FS22?
Are you wondering <b>How To Make Silage In FS22?</b> then read this story through and you'll learn to do silage.
What is <b>The Best Tractor For Silage In FS22?</b> overall you cant go wrong with heavy and big wheels.
You will learn <b>HOWTO Mowe Grass In FS22 Like A Pro</b> in <b><a href="guide-animals.php">PMC Farming Simulator 22 Animals Playing Guide And Tutorial</a></b> page.
Maybe you're thinking <b>How much honey do bees create in Farming Simulator 22?</b> as bee's are easy to keep FS22 animals.
When learning <b>How to get started with FS22 Animal Farming?</b> I discovered some surprising things.
