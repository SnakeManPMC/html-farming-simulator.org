...
<?php include("/var/www/include/section-start.php"); ?>
	<h2>2023-10-20 Making Hay</h2>

<p>
2023-10-20T05:01:00Z New farming day has started, yesterday finished really abruptly because I almost fall asleep in front of the computer, so today have to see what I got done and proceed from there <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Grain reminds me, farm grain bin silo 1 is 74% full and silo 2 is 61% full, hmm I think those still can take one corn harvest, but... what about barley and canola, heh, seems like I have now need for additional farm grain bin silos <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
But thinking it about a bit more... I realized that it has to be done, I need hay, its ingredient for TMR so there is no point of putting all the work for silage if you don't do the other ingredients. So guess its time to go grab mowers and get to work, uuh this will take all morning / noon for sure <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Piece of crap courseplay-gui garbage v7.3.1.3 is broken, it gives "no path found" every few minutes when collecting bales, NNNGGGH! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-023.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-021.php">previous page</a>.
</p>
