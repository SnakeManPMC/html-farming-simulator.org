...
<?php include("/var/www/include/section-start.php"); ?>
	<h2>2023-10-01 Grass Bales To Animal Dealer In A Snow Storm</h2>
...
<p>
2023-10-01T07:56:00Z Finished fertilizing F13 NE tip. Now barley planting season is completely done <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Alright its now nov in-game 1340hrs, next seasonal event is dec with grass best market price, so a lot of grass hauling to do. OK lets get to it then <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Hmph went and checked in-game crop calendar market price thing, it now says grass best market price is on FEB, hum. Wonder why these values change so much, it should not be the random price fluctuations as the selling DAY is still the same, right? <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Jan in-game 0919hrs overnight grass and straw sell price trigger notifications went off, they are now at highest price in animal dealer. Grass is 152 and straw is 146. OK time to break out anderson rbm2000 bale collector and start hauling some 180cm round bales to the animal dealer while its snowing <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Recorded some new autodrive network waypoint routes as well to this new official autodrive MASTER XML config file <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Its kind of wicked to haul grass bales to animal dealer for sell in a blizzard snow storm, I cannot see fields or roads, only thing to guide me is (cheater) autodrive waypoints and the grass between road and fields <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
2023-10-01T09:38:00Z Back and now I have rest of the day dedicated just for animal game-mode farming <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Bales just stacked / dumped by the side of the field seems to work surprisingly well, obviously you should not dump several hundreds of bales at once some field edges surrounding it which might cause FPS issues, maybe, but relaxed casual 180cm round bale piles around a grass field is just fine and works nicely, I don't know how realistic it is to store bales without a shelter or anykind of cover, but this is farmsim, so whatever works... just, works <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Its six and a half, almost seven minutes one way from F13 to the animal dealer and I still have at least 5 round bale loads to haul. Hard work, but hey its the money, gotta get that money <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Okay all the round bales to be sold have been sold, I don't dare to sell grass bales by the farm yard as those are sheep feed <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Hmm whats next, is it barley harvest season next, hmm... Nope, its wool best market price on may. OK more money incoming. Oh forgot to mention, budget now 1.523m <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
All the woold has now been sold, budget now 1.657m <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
Next adjusted convey-all auger pipe to load grain into meridian flat bottom bin 3608, hooked kinze 1121 harvest commander to massey ferguson, midwest durus 18.2m header to claas lexion 8900 combine harvester and then its all systems go for barley harvest season <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Oh wow still two hours harvest even with midwest durus 18.2m header <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
Well dunno, its 18 almost 19ha field so what did you expect, ravenport little girlie men durations? <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Well this is unfortunate, claas lexion 8900 with midwest durus header gives me some performance issue when camera angle is just on the sweet spot with dust and straw particles coming out of the harvesters rear end. Its not too bad, but anytime you break rock solid 60FPS it feels invalid <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
I shiver when seeing the straw swath lexion 8900 is dropping, when you bale that straw up its going to be a boatload of bales again <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
Now with large combine and medium size grain cart, this harvest feels like... "normal" <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Farm grain bin silo now has 342.7k liters of barley, should last a few months as chicken feed <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Choices choices... <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Maybe if I buy the farmland, then four more chicken coops and sheep barns, crank up the heat with animal production, if I have to time accelerate one year, lets make profit quadruple or something <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2023-10-01T18:36:00Z Just started loading bales to anderson rbm2000 when I bothered to check production inspector and to my shock chicken coops were all out of food, HOW did I miss that, what the hell is going on with me right now first I mess up the egg best market price day and now leave chickens without feed!? <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
On animal savegame you cannot ever time accelerate before double checking that animals are fed and production spawn points have enough room <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Man, I'm still shaking my head what two big mess ups I just did there <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Its good to be a millionaire <img src="../images/smileys/icon_cool.gif" alt="Smiley :cool:" loading="lazy">
</p>
...
<p>
Man, playing farmsim is easy and relaxing, making these farm progression decisions is <b>HARD!</b> <img src="../images/smileys/icon_rolleyes.gif" alt="Smiley :rolleyes:" loading="lazy">
</p>
...
<p>
2023-10-01T20:29:00Z Purchased the above list, budget now 514.6k. Still would have enough money for rubicon 9000 but hmm dunno man, it would eat all my money then, wouldn't even leave anything to buy product and pay nightly bills <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-008.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-006.php">previous page</a>.
</p>
