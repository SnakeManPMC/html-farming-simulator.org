...
Please read <a href="test-from-zero-pmc-undefined-farms-20km.php">Test From Zero PMC Undefined Farms 20km Homepage</a> for details.
	...
	<h2>2022-12-28 Fertilizing Contracts</h2>

<p>
2022-12-28T11:59:00Z New farming day has started, last night pushed right into zombi mode, now just woke up, did computer chores, haven't eaten days first meal yet but fired up PMC Gaming and todays plan is to, well just farm more in Start From Zero aka test from zero savegame <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Checked <a href="https://www.farming-simulator.org/22/equipment-vehicle-prices.php">PMC Farming FS22 Equipment and Vehicle Prices</a> page for base equipment and vehicle prices, what kind of stuff with what prices is available if we were to start farming our own land now.
</p>
...
<p>
Guess I could start this day off with a little bit of contracts, just to break the ice so to speak <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Here we go again, GPS driving, I love it heh. Hmm maybe I should have started this with courseplay and go eat days first meal, but nah I wanna drive with GPS <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
But I am hoping this Test From Zero savegame would shed some light on that, new data and experiences to share with everyone <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2022-12-28T12:49:00Z Now I realized why F466 was not flashing in mapview... I did not accept the contract heh, did it now <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-28T13:09:00Z Finished contract fertilizing F292, collected reward 85.5k. Budget now 510k, whoah I could now buy my first rubicon 9000 too <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-28T14:11:00Z Driven to F466 while recording autodrive network waypoints and target points. Now its time to fertilize again <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Why the hell is it always so hard to make decisions <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Sent rubicon to F13 and Kubota M6-141 to F17. So guess we are doing few more fertilizing contracts for that big money <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-28T15:50:00Z Started contract fertilizing F17, manually GPS. Now we are making some money <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
2022-12-28T16:01:00Z Rubicon ran out of liquid fertilizer, oh my it goes through that juice like its nothing <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
Drove rubicon manually to the dealership, purchased 4 liquid fertilizer tanks and refilled this beast. Oh man it will take several refills to fertilize whole F13 <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-12-28T16:23:00Z Rubicon empty again, refill time <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-12-28T16:45:00Z Was recording new autodrive network waypoints that didn't even notice, rubicon is empty again heh. Okay the usual 5 tank refill routine, you know the drill <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-28T17:57:00Z Rubicon is empty, sigh. Did not manage to decide how to handle this better so used autodrive to send rubicon back to the dealership for a refill. This is crazy long round trip <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Autodrive ETA said 11min, oh wow and that crap is ONE WAY, aargh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-12-28T18:25:00Z Kubota reached rubicon's fertilized row, now vehicles are in head on collision course, they are playing chicken with farm machinery <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
2022-12-28T18:28:00Z Vehicles met in the center of the field, contract is now 95% complete, only thing left to do is the headland. But this is excellent point to save game and go take a lunch break <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Life is hard, why cant I have good vehicles just by snapping my fingers <img src="../images/smileys/icon_rolleyes.gif" alt="Smiley :rolleyes:" loading="lazy">
</p>
...
<p>
2022-12-28T20:00:00Z I still could not decide what to do so I'm going to punish myself for being such indecisive WUSSY and I'm taking ALL the fertilizing and spraying contracts on the board now. Lets see once those are done how much money we have and what mood I am in <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
2022-12-28T20:17:00Z Finished contract fertilizing F592, collected reward 9.8k. Oh my almost ten grand <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-28T20:40:00Z Finished contract fertilizing F19, collected reward 38.3k. Sent rubicon to the dealership and I went to restroom <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Purchased iconik liquid fertilizer station placeable for 7.5k, put it on farm yard F0079. This is the N-NW sector. There is no point running back and forth to the dealership for refills, large scale farming is about having stuff in the boonies <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Kubota M6-141 + DSX-W Geospread reached F64... and instead of "just stopping", something odd happened, autodrive or courseplay not sure which, continued the courseplay field work fertilizing course automatically, I did not have to drive the tractor to the field and start from the "last position" field work course, wow that was cool! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
All contracts complete, budget now 715.3k, nice! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>

<p>
Sold the placeable buying stations, was trying to send vehicles back to the dealership but realized that oh right there is no autodrive network waypoint route yet, OK lets get it done next while we travel back to the home base <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Just realized I have harvest ready sorghum in F22, dunno if it would make much money but it would be kind of free money. Not that I have any grain bin silo to store them heh. Oh right forgot about that one, all these Start From Zero equipment planning and I never considered farm bin silo <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-test-from-zero-pmc-undefined-farms-20km-003.php">next page</a>, <a href="stories-test-from-zero-pmc-undefined-farms-20km.php">Test From Zero PMC Undefined Farms 20km Home</a>, go back to <a href="stories-test-from-zero-pmc-undefined-farms-20km-001.php">previous page</a>.
</p>
