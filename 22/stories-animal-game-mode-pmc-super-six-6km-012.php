...
<?php include("/var/www/include/section-start.php"); ?>
	<h2>2023-10-06 Pig Farm Yard Creation</h2>
...
<p>
Set the dealership delivery point to pig farm yard and purhcased 8 * big bag pig food for 7.2k I think it was. Refilled pig food into penta db50 trailer, then dumped the massive 8k liters of pig food into Pig Barn 1 feed input silo, now I'm ready to buy some pigs, well, technically <img src="../images/smileys/icon_razz.gif" alt="Smiley :p" loading="lazy">
</p>
...
<p>
Okay now I am a pig farmer! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>

<p>
Then purchased another 8 big bags of pig food for 7.2k * 4. Then refilled penta db50 with this 32k liters of pig food and finally dumped it into Pig Barn 1 feed silo, OK now I am already bored to death for this bag purchasing and trailer refilling activity <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
My plan now is very simple; plant and harvest pig food crops myself, this includes base food <b>corn</b>, grain <b>barley</b> (I'm already doing it), protein <b>canola</b> and root crops <b>sugar beets</b>. So I have to purchase following items:
</p>
...
<p>
Man, looking at that list... its kind of simple, but at the end of the day... it will be some work, for example "small field for sugar beets", now where do I find such thing in PMC Super Six 6km terrain? Maybe the ones in SE region, but that is then huge driving back and forth hauling those sugar beets to pig farm yard <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Pig farmers life ain't easy <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Pig Barn 1 slurry: 10.7k liters already heh, filthy pigs pissing all over themselves, nice <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Feb in-game 0915hrs went to visit my new farmlands for the first time heh. F08 and F29 looking good, big <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
You absolutely gotta be kidding me, checked the dealership sales and that kinze 3665 planter I bought is now for sale there, hah the timing <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Mar in-game 0913hrs honey market price is 3417 at Rock Specialty Crops CO and pretty much all animals need some feeding now, so going to be a busy day that's for sure <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Fed the chickens and pushed one grass bale around to get Sheep Barn 4 back again to food: 100% status. Then collected all wool and egg pallets to the edge of the farm yard. Then picked up trailer full of honey and headed off to Rock Specialty Crops CO selling point. Almost 9min ETA according to autodrive <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Oh man this is borderline not worth my time to drive all the way to the other side of the terrain for such profits <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Pig food ingredient crop seed goes to the ground, yeah buddy! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Went to refill from seed production building, then back to F30 N... and I was writing this text when tractor reached F30 N, then autodrive handed control over to courseplay-gui garbage as it detected somehow that tractor has a seeder and unfinished field work course. Very nice <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Oh my dropped below million <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
All wool sold, budget now 1.293m yeeah buddy, back at the millionaire status <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-013.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-011.php">previous page</a>.
</p>
