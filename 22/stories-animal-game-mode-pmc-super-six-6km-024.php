...
<section>
	<h2>2023-11-04 First Silage Operation</h2>
...
<p>
Canola harvest, aayeah gimme those black oily pearls <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Now that a long field work course started and I have more time to think its good to write down some notes. So yeah today I woke up and straight outta bed was really bored, could not get nothing started, I managed after huge struggle to create and write <a href="https://www.pmctactical.org/arma3/dev-diary.php" target="_blank">PMC Tactical ArmA 3 Dev Diary</a> web page, so guess that's something. But after that I took a nap just because I was so bored, staring at empty computer screen waiting for RSS news to arrive, had to do something so nap was my only hope to get into more motivated mood, sometimes it works. After getting up was still bored but somehow like said above I just launched FS22 and here I am. Now I feel very enthusiastic to farm in general, but more specifically to finally get into cattle / dairy cows by starting that corn chaff forage harvest going on for silage bunker, I cant wait! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Aahh juicy smelly steaming slurry <img src="../images/smileys/icon_razz.gif" alt="Smiley :p" loading="lazy">
</p>
...
<p>
Again didn't even notice "this morning", Pig Barn 1 animals: 720 / 2400 now, happy birthday piglets <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Sounds stupid but I like this field work right now, this savegame is currenly not just about reaching some goal with whatever means necessary, I simply enjoy slurry spreading and guess I'll run ripper to this field after its done, will be some good farming <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
I tried to make courseplay-gui garbage to generate diagonal inner rows, but no dice, the degree amount makes no difference, it just generates 270/90 heading inner rows, sucks <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Aug in-game 0731hrs canola planting season has started. Pig Barn 1 animals 900 / 2400, happy birthday piglets <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Went to check F31 corn, its growth stage is now 5/6 (forage), so I could start corn chaff forage silage operation today, nice! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Purchased 60 liters of silage additive for 2.9k, then refilled jaguar 980 forage harvester with silage additive. Then massey ferguson and penta db50 recorded autodrive network waypoint routes target point for silage bunker 1 dump, tested that it works OK, it does, excellent, now I'm ready to begin a big silage operation <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Goodness gracious <b>five HOURS and forty minutes</b> field work duration, oh my oh my! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
For now though, I'll just enjoy this savegames very first corn chaff forage harvest <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Then mopped up headland corner missed spots, drove fendt 939 vario with amazone citan 15001-c seeder to chicken and sheep farm yard, diesel refueled fendt, seed refilled seeder and then drove it to pig farm yard where I dropped off seeder and picked up penta db50 trailer. Now fendt 939 vario joins silage operation <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2023-11-05T04:15:00Z Took this long before courseplay-gui garbage failed in silage operation, steiger 620 with silage blade stopped at silage trailer tractors path, had to clear that mess up. Very sad that this is definitely not hands free operation then but just another baby sitting job... <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-025.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-023.php">previous page</a>.
</p>
