...
<p>
Dunno, it kind of feels like cheating, but heh I mean it is not, technically it is not, you are feeding the chickens and haul product for sell, if you simply time accelerate then number one chickens don't produce any eggs without feed and number two, no product (eggs) get hauled to the selling point, so no, its not cheating no matter how much it feels like it <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Wicked! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
When I'm thinking about growing my farm, its becoming clear I need to get rid of that pussy cry-baby attitude that "boohooo field work takes 3hrs!!1" for example on F13 harvesting with 8.5m header, it takes as long as it takes, if you don't want to suffer buy better equipment, bitch <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Maybe a better plan can be achieved after I'm done selling all the straw and grass bales from this current harvest season. Having said all that mumbo jumbo above, I'm still not looking forward to buying a new 33ha field and then spend 5+ hrs working on it with 6m seeder and 8.5m harvester header <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
One thing I'm really proud of in this savegame... is the fact that I have done 0 contracts and sold 0 liters of grain <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Aaah grass baling is done, last one for F13 CP-02 and CP-03 sections! Whohoo <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2023-09-28T08:37:00Z Finished collecting and stacking bales along the sides of F13 <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Deleted courseplay-gui garbage custom fields CP-01, CP-02 and CP-03, ahh now I feel good <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
One more field work before time acceleration continues to the next seasonal event, no idea what that will be but it should be one of the product selling days. Its again very satisfying to watch bredal k165 crawl 18km/h around the field which is peppered with grass and one straw round bale piles <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-006.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-004.php">previous page</a>.
</p>
