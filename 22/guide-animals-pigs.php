...
<html lang="en">
<head>
<title>Animals Guide Pigs - PMC Farming Simulator 22 (FS22)</title>
<LINK href="../css.css" rel=stylesheet type="text/css">
<META name="description" content="Animals Guide Pigs - PMC Farming Simulator 22 (FS22)">
<meta charset="UTF-8">
...
<h1>Animals Guide Pigs - PMC Farming Simulator 22 (FS22)</h1>
<?php include("/var/www/include/header-end.php"); ?>
</header>

<section>
<?php include("/var/www/include/section-start.php"); ?>
	<h2>Animals Guide Pigs (FS22)</h2>

<p>
Pigs productivity is about <a href="guide-animals-product-manure.php">manure</a> and <a href="guide-animals-product-liquidmanure.php">slurry (liquidmanure)</a>. Overall pigs productivity 0% doesn't mean anything, for example when you empty pig barn slurry tank... pigs productivity goes to zero, OH MY! Heh yep, no need to worry, its just an empty slurry tank ready for pigs to take a piss into. Note: pigs ESC animal menu has no productivity statistics, you can only see it on <a href="https://github.com/jtsage/FS22_ProductionInspector" target="_blank">JTSage's Production Inspector</a> mod.
</p>
...
<p>
About pigs prices to sell, see <a href="guide-animals-selling.php">FS22 Animals Guide Selling</a> page for details.
</p>
