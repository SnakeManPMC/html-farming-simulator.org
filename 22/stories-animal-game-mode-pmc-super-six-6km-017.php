...
<section>
	<h2>2023-10-12 Big Problems With Pigs</h2>
...
<p>
2023-10-12T20:46:00Z Pig Barn 1 protein is now 4%, should last at least one full day again. Oh and wow, didn't even notice (again), more piglets have been born, animals: 900 / 2400, oh my oh my! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>

<p>
Man those pigs breed, no wonder the food keeps getting consumed in even increasing speed <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2023-10-12T21:01:00Z Pig Barn 1 protein: 4%, it runs out after tomorrows time acceleration and ... geez dude, I don't think I can keep doing this until canola harvest, I mean seriously considering SELLING ALL MY PIGS until I have a full food production tool pipeline running! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
I mean yes its drastic, but come on, you do 32 big bags purchase, refill to trailer ONE-BY-ONE, and then dump to feed silo, for SEVERAL TIMES and lets see how eager you are to keep continuing doing it <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Also, I have 900 pigs, most expensive "set of pigs" is only 1016 so well below the max price and there is no point selling them off before pigs are fattened enough for the full 1200 price tag. But hmm still not sure, need to think about it. Checked crop calendar and the long awaited canola harvest season begins in jul, that is 5 time accelerations which seems to make pigs eat that whole protein 4% food load, no man, I'm not going to do the pig food big bag shuffle for 5 more times, noway! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Sold ALL MY PIGS! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
Switched my gameSettings.xml into Quarantine mod dir setup and tested FS22_ChickenBarnXL.zip mod, I already suspected its useless placeable building for chickens and indeed it was, read more details from PMC FS22 Mods page (once I publish it). I had high hopes for a big chicken coop building but unfortunately this it not it.
</p>
...
<p>
2023-10-12T22:32:00Z Purchased four more chicken coops, they are now called Chicken Barn 5 through 8 <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
These bee's man, they are all but worthless, I mean 32k profit for one strautmann 802 sek load of pallets, is it even worth the time to drive back and forth into the selling point, I hardly think so ... <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Now I'm even thinking about purchasing another farm yard farmland and spam another 4 or maybe even 8 set of chicken coops there, that would be quite sick money then while selling eggs <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
As said, chickens are not a cheat, you have to feed them and collect pallets, that is not cheating like money making generators (wind turbines, solar panels, etc). But I'm not going to deny that it is very "gimme my moneyz now!!1" type of game-play if you spam like 10+ chicken coops just to sell eggs <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Massey ferguson hooked up with bredal k165, just in case I run out of slurry. Then switched into fendt 939 vario and hooked it up with samson pg ii 35 slurry spreader, lets get this manure show on the road! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
F07 is pretty much too small for rubicon 9000 massive 48.5m width <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Two tractor mowing field work course, this will be fun and fast <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Oh wow one hour even with two mowers, hoh <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
After a first bale was done I stopped massey ferguson and inspected the bale, it was GRASS 7500 liters, hmm ok well this is the same size as previously which did not fit into kuhn sw 4014 bale wrapper, so I freaked out and took fendt 939 vario, drove to pickup bale wrapper, tried to wrap the bale and guess what... the bale did not fit. WHAT THE FRIG!? I double triple checked massey ferguson baler and F1 menu clearly shows "Change bale size (150cm)". So I MANUALLY drove and baled one bale, inspected it and okay now it is 5.5k liters which is the 150cm round bale. Okay so why the heck courseplay-gui garbage field work course ejaculates 180cm round bales? <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Then restarted field work course and *NOW* frigging finally courseplay-gui garbage ejects 150cm round bales of 5.5k liters! Unbelievable! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Now I'm just waiting as courseplay-gui garbage is running two bale wrapper tractors <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2023-10-13T06:33:00Z Oh wow didn't even realize, silage is 529 at animal dealer right now while my tractors are wrapping silage bales like crazy <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Its a wrap! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-018.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-016.php">previous page</a>.
</p>
