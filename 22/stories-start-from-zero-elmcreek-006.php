...
Please read background information from <a href="stories-start-from-zero-elmcreek.php">FS22 Stories Start From Zero Elmcreek Homepage</a> which explains few things if you're first time reader.
	...
	<h2>2022-09-18 Fertilizing And Wheat Harvest Contracts</h2>

<p>
2022-09-18T15:13:00Z New farming day has started, well not really, just downloaded and updated mod dir with FS22_CustomMissionRewards.zip from darius_frost SGA dude, I want to check if that works without errors and how does it increase the contract rewards in elmcreek. As I mentioned yesterday I don't think this is a suitable mod for large terrains because the contract rewards will be crazy high then, dunno.
</p>
...
<p>
Unfortunately I cant say that there was some <i>"happy times"</i> with contracts using this custom mission rewards mod, yes I do see a slight increase in payouts, but still its quite peanuts by my standards. Guess there is just no escaping the fact that all fields are piece of crap little girlie men sizes in elmcreek.
</p>
...
<p>
Oh forgot to mention, budget now 427.5k, but guess it was already mentioned in yesterdays farming session <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<a href="screenshots/Start-From-Zero-Elmcreek-2022-09-18T1557.jpg" target="_blank"><img src="screenshots/thumbs/Start-From-Zero-Elmcreek-2022-09-18T1557.jpg" class="terrainimg" loading="lazy" alt="Start From Zero Elmcreek Farming Simulator 22 Screenshot"></a>
...
<a href="screenshots/Start-From-Zero-Elmcreek-2022-09-18T1616.jpg" target="_blank"><img src="screenshots/thumbs/Start-From-Zero-Elmcreek-2022-09-18T1616.jpg" class="terrainimg" loading="lazy" alt="Start From Zero Elmcreek Farming Simulator 22 Screenshot"></a>
...
<p>
The decision not to take additional harvest contracts was a good one, with grain being wheat on this first field and grain trailer so small, I simply have no time to tend to another field, its mere couple of minutes free time as grain trailer / cart driver before combine must be unloaded again. We'll do this contract and then re-evaluate our situation and mood <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Back to <a href="stories-start-from-zero-elmcreek.php">Start From Zero Elmcreek Home</a>, or <a href="stories-start-from-zero-elmcreek-005.php">previous page</a>.
</p>
