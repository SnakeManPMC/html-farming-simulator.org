...
<html lang="en">
<head>
<title>Test From Zero PMC Undefined Farms 20km PMC Farming Simulator 22 Stories</title>
<LINK href="../css.css" rel=stylesheet type="text/css">
<META name="description" content="Test From Zero PMC Undefined Farms 20km PMC Farming Simulator 22 Stories">
<meta charset="UTF-8">
...
<p>
I am really considering creating better contracts mod github issue ticket for feature which would sort the contracts by distance to dealership and between selling points. But perhaps this is too complex to script... and how many people are even having these problems, surely not those 2km little girlie men terrain wussies <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Unloaded to the grain trailer and its now got 9017 liters while better contracts menu shows "to go" 9800 liters. Contract now shows 94% complete. If "to go" number is accurate, I cannot complete this contract <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2022-12-27T13:35:00Z Dumped 9017 liters to PMC Sell 01, contract finished! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
Oh wow 4.6k heh, massive amount of cash <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Uh oh this field is growing ... hmm canola maybe, so I cannot see the field dirt where have I spread already, oh well just need to use the field ends as guideline and hope my aim is accurate <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-27T13:51:00Z Finished contract fertilizing F26, collected reward 7.3k. Reimbursement was 2139. Budget now 8.4k <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-27T14:03:00Z Finished contract fertilizing F20, collected reward 6.6k. Reimbursement 2.3k. Budget now 11.8k, broke magical 10k limit wohoo <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-12-27T14:09:00Z Started contract fertilizing F04, manually driving. Uh in this sunflower growing crop it was nearly impossible to see where you already spread <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
On the second pass I by mistake left about 5m empty spot. I must say its rather painful to drive blind <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
But that is one of the Start From Zero points, you start with poor equipment and then slowly after hard work upgrade into good equipment <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
I truly cant wait to get into own land + vehicle so can use GPS <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-27T14:20:00Z Finished contract fertilizing F04, collected reward 24.3k. Reimbursement 5k. Budget now 25.8k. Slowly increasing our budget, growing our farming empire <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Well that went belly up fast, on second pass I was ONE ROW OFF, argh! <img src="../images/smileys/icon_evil.gif" alt="Smiley :evil:" loading="lazy">
</p>

<p>
Mapview was so inaccurate on 20km terrain that it didn't even detect the almost one row off distance, so its hopeless to check map if you're on the right track. Man this crap ain't easy! <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
Decided to juggle a bit, going to accept borrowed vehicles contract for a small field which has nice amazone spreader, then accept all the dealership nearby fertilizing contracts WITHOUT vehicles <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-27T16:46:00Z Started contract fertilizing F12, manually driving. This field was also completely blanketed with plants, no way to see where I'm spreading <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-12-27T20:26:00Z Had to take a restroom break because mind started to go numb by the endless 2D top-down driving so I can see fertilized ground. Uuuh... booring <img src="../images/smileys/icon_evil.gif" alt="Smiley :evil:" loading="lazy">
</p>
...
<p>
2022-12-27T20:56:00Z Was surprised when alarm went off for a lunch break, already? Huh? Its been THAT mind numbing experience to fertilize this field uuh. OK finishing this pass and then its lunch break time <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Uaah frigging finally. My brain melted with that surreal 2D top-down view watching where green plants waterfall style flowed from top to bottom of the screen, just terrible way to spend few hours <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Alright let this contract be the last one with manual driving because I CANNOT SEE CRAP in fields <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
All done, YEAH! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Now I can start to use GPS, courseplay and autodrive because I own my own land and vehicle(s) <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-12-27T23:03:00Z Started contract fertilizing F11, manually GPS. YEAH BUDDY! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>

<p>
You have NO IDEA how GOOD it felt to drive with your own new tractor using guidanceSteering! It is so awesome! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
GPS is so nice, man all those hours I suffered without automation tools and could not even see where in the fields I spread fertilizer, such an torture heh, so glad that part is now over and now we can just enjoy GPS, courseplay and autodrive <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Immediately after starting to use GPS I switched into cab view, its so cool to just chill there driving around the field without needing to worry if you are veering off course or anything else <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
Kubota M6 series and DSX-W Geospread box is pretty nice, nimble little spreading package for 10k liter capacity which is not so bad considering. This reminds me of the good old times in FS17 Cornbelt when I used this kind of back spreader box, was it KUHN EMC something cant remember anymore. Good times <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
BTW now with Kubota M6-141 + DSX-W Geospread I already feel like printing money mode with fertilizing contracts. Its usually the rubicon 9000 phase when you just blast through those contracts and collect them moneyz <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
This field was just planted, so finally got a fertilizing contract with a pure dirt field surface <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Budget now 355.5k oh my <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
Budget now 424.6k whoah <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-test-from-zero-pmc-undefined-farms-20km-002.php">next page</a> or back to <a href="stories-test-from-zero-pmc-undefined-farms-20km.php">Test From Zero PMC Undefined Farms 20km Home</a>.
</p>
