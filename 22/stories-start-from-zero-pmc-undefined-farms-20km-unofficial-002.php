...
Please read background information from <a href="stories-start-from-zero-pmc-undefined-farms-20km-unofficial.php">FS22 Stories Start From Zero PMC Undefined Farms 20km Unofficial Homepage</a> which explains few things if you're first time reader.
	...
	<h2>2022-05-08 Hay Baling Contract</h2>
...
<p>
Currenly the NE or perhaps SE edge of the field is getting harvested. And right off the bat I'm off to eat my days first meal, but I'll do it while courseplay is harvesting, will probably have to do one combine unload while eating but its no big deal <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Combine then finished the SE corner of the field and moved into the "zig zag parts", where it has to do almost constant turns, this is a huge time waste as courseplay slowly are making those unnecessary turns. Oh well, more time for me to eat <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
2022-05-08T17:51:21Z Feeding time is over, now semi-truck grain trailer driving and the combine gets my full attention <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
<i>"my farm is so broke that we don't even have a grain cart, have to to use super-liner 6x4 mack semi-truck to unload combine. that semi is extremely uncomfortable to drive as it has the "hit throttle acceleration lag" due new and "improved" fs22 physics."</i>
</p>

<p>
<i>"trying to line up combine auger to the grain trailer is the usual aircraft "dont chase the gauges" situation. hmm gotta get myself a grain cart, already got a tractor to pull it."</i>
</p>
...
<p>
Whoah that took a while <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Then ran across the field and found one small tiny patch of soybeans in SE tip, went and cleaned that up as well, now we are fully done. Cleaning the leftovers up grained me 213 liters <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-05-08T20:44:41Z Turned NVIDIA DLAA deep learning anti aliasing (?) on, 60FPS solid and excellent image quality. Umm and added... err did I add some mod, heh don't think I did <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
On the first corner mower under courseplay control went off to a random direction, oh man... seems like courseplay is buggy as hell <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
It was quite the amazing sight to see courseplay without an actual course, drive that tractor and collect bales like a professional. Just very cool <img src="../images/smileys/icon_cool.gif" alt="Smiley :cool:" loading="lazy">
</p>
...
<a href="screenshots/Start-From-Zero-PMC-Undefined-Farms-20km-2022-05-08T2322.jpg" target="_blank"><img src="screenshots/thumbs/Start-From-Zero-PMC-Undefined-Farms-20km-2022-05-08T2322.jpg" class="terrainimg" loading="lazy" alt="Start From Zero PMC Undefined Farms 20km Farming Simulator 22 Screenshot"></a>
...
<p>
Jun 1st in-game 0941hrs, soybeans highest market price is 3527 and its on PMC Sell 01... which is right next to, or shall I say IN our farm yard <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-05-09T00:07:50Z Sold last truck load, budget now 801k <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
2022-05-09T07:02:00Z First kinze 1051 auger wagon offloading into semi-truck grain trailer <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
My day is already long, but I got a bad attitude that I'll get this canola harvest finished tonight or die, err I mean fall asleep, trying <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Been already planning that tomorrow I'll continue editing, no more "wasting time" playing. I was working on first release for <a href="../19/pmc-grande-gardens-16km.php">PMC Grande Gardens 16km (FS19)</a> when I got hit with such a bad burnout moment/day that somehow I got derailed and ended up playing. Sure the Asus RTX 3060 TUF Gaming 12gb card I just got had to be tested, but still I'm already fed up with fs22 farming, its time to go back to editing.
</p>
...
<p>
Continue reading <a href="stories-start-from-zero-pmc-undefined-farms-20km-unofficial-003.php">next page</a>, <a href="stories-start-from-zero-pmc-undefined-farms-20km-unofficial.php">Start From Zero PMC Undefined Farms 20km Unofficial Home</a>, go back to <a href="stories-start-from-zero-pmc-undefined-farms-20km-unofficial-001.php">previous page</a>.
</p>
