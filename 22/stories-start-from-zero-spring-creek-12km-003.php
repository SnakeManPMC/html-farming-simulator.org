...
Please read background information from <a href="stories-start-from-zero-spring-creek-12km.php">FS22 Stories Start From Zero Spring Creek 12km Homepage</a> which explains few things if you're first time reader.
	...
	<h2>2022-04-25 Endless Herbicide Spraying</h2>
...
<p>
Was just editing <a href="https://www.pmctactical.org/arma3/pmc-chechnya-grozny.php" target="_blank">PMC Chechnya Grozny ArmA 3 terrain</a>, did some good work there but now it went to the long processes phase and I got bored, wanted to farm and decided to fire up FS22 for some more spraying contracts. Lets make some money.
</p>
...
<p>
But this field is bugged, gives me the <i>"you dont have access to this land"</i> error on large parts, I don't think this contract can be completed...
</p>

<p>
Yup its a no go, gives so much error that this contract has to be cancelled <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
My plan now is to format windows 10 installation and go back to FS19 playing and editing, I need to release <a href="../19/pmc-grande-gardens-16km.php">PMC Grande Gardens 16km</a> and <a href="../19/pmc-iowa-garden-city-8km.php">PMC Iowa Garden City 8km</a> as those are so overdue its not even funny.
</p>
...
<p>
Go back to <a href="stories-start-from-zero-spring-creek-12km.php">Start From Zero Spring Creek 12km Home</a> or <a href="stories-start-from-zero-spring-creek-12km-002.php">previous page</a>.
</p>
