...
<?php include("/var/www/include/section-start.php"); ?>
	<h2>2023-10-19 Cattle Equipment And Planting Season</h2>
...
<p>
Then saved game to lock in those changes <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2023-10-19T05:21:00Z Feeding time is over, back to see what fun I can have with my new purchases <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Then autodrive sent case ih steiger 620 with john deere 2410 ripper to F07, I want to give my new toys a try <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Oh man I love ploughing or plowing or digging or ripping or whatever you want to call this, F07 ground texture looks so nice now as its that dark brown plowed texture, ahh so nice <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
Whoah only movie duration, I was fully expecting more than two hours field work course out of this one, OK nice, I'm good with movie duration <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
The reason I did this with inner rows first was just to change things up a bit, make it more fancy digger ripper field work course, do "end rows" last to reduce the compaction there. Heh full in with meaningless role-play bullcrap <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Then loaded penta db50 with 23k liters of barley, hauled it to pig farm yard and dumped into pig barn 1 feed silo (meridian tl 12-39 auger pipe). Here is a tip for myself; don't do these food refills after time acceleration, do them when other field work courses are running, its the perfect time to spend relaxed time to feed animals, there is no point to dedicate my real life game-play time to just feed animals without doing anything else. For example planting; feed animals, mowe grass; feed animals, plow field; feed animals... etc <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
As I said on previous days farming sessions, this honey selling is so useless peanuts shopping that uh, why do I even drive to selling point and back for mere thirty grand... <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
While massey ferguson with strautmann 802 sek trailer was returning to farm yard I took fendt 939 vario, hooked it up with kinze 3665 planter and autodrive sent it to F07 S, its sugar beet planting time. Not sure where do I put these beets but, heh gotta get stuff planted <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Ooh I love planting on plowed dark brown ground field texture <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Fendt 939 vario with twin wheels and front weight was bouncing quite a bit when planting, but heh its no big deal, makes no difference technically <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Then mopped up headland corner leftovers, now its really sweet sugar beet field. Just no idea where to dump those beets <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Apr in-game 0916hrs its now wool best market price, time to sell. Autodrive sent fendt 939 vario with kinze 3665 to F29 W, it is also corn planting season, its going to be a busy day <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Uh oh just realized... I was too horny to start corn planting and completely, utterly, forgot to fertilize F29 <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-animal-game-mode-pmc-super-six-6km-022.php">next page</a>, <a href="stories-animal-game-mode-pmc-super-six-6km.php">Animal Game-mode Home</a>, go back to <a href="stories-animal-game-mode-pmc-super-six-6km-020.php">previous page</a>.
</p>
