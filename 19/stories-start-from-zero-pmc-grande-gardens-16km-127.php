...
Please read the background idea for <a href="stories.php">our Farming Simulator 19 Stories</a> so you understand what is this all about.
	...
	<h2>2024-01-21 Aftermath Of Diagonal Field Work Courses</h2>
...
<p>
Aayeah, another field done, in the darkness! Yes! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Another field done, great progress, I love it <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Got still plenty of harvest to do, but if tomorrow daylight would not be ruined by crop / soil moisture, then it would be no problem. In fact I'm really surprised that its now in-game 2258hrs and soil is not moist yet, I had recollection that soon after it gets dark soil gets wet, hmm guess not then <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
2024-01-21T09:42:54Z Unfortunately I was right... forecast was right, soil froze up during night time and temperatures were not above +0C to thaw it the next day, so I missed my harvesting opportunity, soil is frozen I cannot harvest anymore, my soybeans for F151, F68 and F69 will now wither! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Aww man that sucks! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
But this is what I love about FS19 Seasons mod, there is the random chance of you running out of time because weather events, I mean didn't this harvest season begin late because rain, what if that rain didn't happen... I could have easily finished these soybeans fields harvest then. In FS22 you have the conzole peasant dumbed down trash "seasons" which is nothing but cosmetic crap, it has no moisture, no temperature, no crop rotation, <i>no nothing</i>. I am so glad FS19 Seasons mod is available for my farming enjoyment, I love it.
</p>
...
<p>
Actually I need to read my own FS19 stories through, search for "seasons days" keywords, maybe I have my own references there. <i>Edit: I have now documented this to my local notes, I wont be making this mistake ever again. Making dumb mistakes is perfectly fine... when you actually learn from them.</i>
</p>

<p>
2024-01-21T09:52:15Z Time accelerated to 03/late-winter, soybeans are now withered, what an extremely sad sight to look the horizon of F151, F68 and F69 with just gray DEAD soybeans as far as eye can see <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Alright going to save game here, shut down FS19 and PMC Gaming computer, need to do research and a new plan of action for the next season. Most likely I'll return with new knowledge (err refreshed knowledge?) and motivation to start a new planting season, hey maybe I'll crank up the heat with 24 day seasons config and do this whole SW region of the remaining fields in one go heh, big boy stuff <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-start-from-zero-pmc-grande-gardens-16km-128.php">next page</a>, <a href="stories-from-zero-grande-gardens.php">Start From Zero PMC Grande Gardens 16km Home</a>, go back to <a href="stories-start-from-zero-pmc-grande-gardens-16km-126.php">previous page</a>.
</p>
