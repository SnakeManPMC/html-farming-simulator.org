...
Please read the background idea for <a href="stories.php">our Farming Simulator 19 Stories</a> so you understand what is this all about.
	...
	<h2>2024-01-27 Seasons Config To 24 Days</h2>
...
<p>
Hmm I might skip the small fields and only do the large fields in S-SW region, that could be one option, make my return to this savegame with a huge field harvest <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
01/early-spring in-game 0930hrs, weather +5C/+1C, okay new year has started, now I got a long way to time accelerate until its soybeans planting season and temperatures <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
15/mid-spring in-game 0945hrs, weather +11C/+8C, still not ready for soybeans planting season, not even close <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2024-01-27T23:00:55Z SW train reached railroad silo 1, it does connect to NW train and therefore to NE train as well. SW train then connects to SE train so the circle is complete <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Refilled SW train with 251.7k liters of seeds, hopefully that is enough for all these hectares in S-SW region <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
20/late-spring in-game 0748hrs, weather +13C/+11C, okay soybeans planting season has begun, fire up the air drills and get to work <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Aayeah, seeding soybeans, again, to this same field, this time with two vehicles <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2024-01-28T00:21:14Z Big bud 747s reached N edge of the field, oh man that middle part is so narrow with just one headland those seeded parts almost touch each other from S and N now, this field is the dumbest shape ever, I am never going to make this kind of irregular badly shaped fields anymore and need to fix this and others in my terrains. These are simply not fun to field work <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
It just feels so frustrating of doing nothing, so funny to play a game where you do nothing but sit back and watch. Guess in many ways something like <a href="https://www.pmctactical.org/cities-skylines/" target="_blank">Cities Skylines</a> is the same once you have build your city enough, there is not much to do other than watch and enjoy the city-scape.
</p>
...
<p>
Continue reading <a href="stories-start-from-zero-pmc-grande-gardens-16km-129.php">next page</a>, <a href="stories-from-zero-grande-gardens.php">Start From Zero PMC Grande Gardens 16km Home</a>, go back to <a href="stories-start-from-zero-pmc-grande-gardens-16km-127.php">previous page</a>.
</p>
