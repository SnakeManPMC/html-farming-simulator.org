...
Please read the background idea for <a href="stories.php">our Farming Simulator 19 Stories</a> so you understand what is this all about.
	...
	<h2>2022-04-27 A Good Day Doing Contracts</h2>
...
<p>
Its impossible to explain here as I cannot go into details of what happened, but had a hard time slipping into the farmsim mind-set after being pissed off "at the world", started watching penalty_box_gaming twitch live stream where he plays fs22 with <a href="../22/pmc-redwhiteblue-10km.php">PMC RedWhiteBlue 10km</a> terrain and in the chat there was clearly some trolls, seems like I cannot escape the bullcrap as it follows me everything today heh. Right now I'm sitting here at 02/mid-spring in-game 1315hrs, weather +15C/+5C, budget now 440.8k ... and dunno what to do first/next... as cant get that relaxed farming mind-set on <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Read my own notes from <a href="https://www.farming-simulator.org/19/equipment-vehicle-prices.php" target="_blank">FS19 Equipment and Vehicle Prices</a> which show that painfully small/slow/narrow vehicle fleet costs 332.1k which could technically get you started with the own farm. But I'm not sure if that is wise, those vehicles are SO painful <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Hmm actually thinking about it more now, I should have probably purchased cheap tractor and bredal k165 spreader, I would had the permission to use courseplay and GPS at that point (<i>Edit: again NO, no you wouldn't, you dumb moron</i>), and such vehicle would have come useful for sure in the future. But maybe after this contract-set I can buy a rubicon 9000 which is even better.
</p>

<p>
Driving to the fields I made my decision, after these contracts I buy my own vehicle so can use courseplay and GPS <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-04-27T16:54:25Z Finished fertilizing F180, it was so small it went by within a minute. Collected contract reward 1.2k, oh my! Big boy farming <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Big field <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Alright, I promise, this is the LAST contract I'm driving manually <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2022-04-27T18:19:05Z Yeah keep driving manually it really takes its toll, its fun on the beginning, its "cute", back to the roots kind of thing, however when you do it for <b>COUPLE OF DAYS...</b> yeah not so cute anymore...
</p>
...
<p>
Budget now 554.4k. Broke half a million magical limit <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-04-27T19:03:02Z Now I'm at 02/mid-spring in-game 0914hrs, weather +8C/+7C and yeah new season has started but all AI fields are still excatly the same as "last year". I am having difficult time deciding what to do. It is so funny that this is a frigging <b>*VIDEO GAME*</b> and I'm having hard time making decisions <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
<i>"Don't be afraid to fail. Don't be afraid to make decisions. You can't be paralyzed by fear of failure or you never push yourself."</i>
</p>
...
<p>
Hmm I could be sneaky, buy land with F253 on it for 432k, lease combine, tractor and trailer, then harvest the soybeans in F253 and get a lot of money back. After that I could continue contracts to make some money, unless I have enough to buy seeding and harvesting equipment which I highly doubt, hmm. Dunno, cant decide <img src="../images/smileys/icon_razz.gif" alt="Smiley :p" loading="lazy">
</p>

<p>
Hmm what if I would be even more sneaky... I would take the harvest contract for F181 soybeans with borrowed vehicles, do that... then buy land with F253 and harvest it using the borrowed vehicles <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Hehe... that sounds nasty and sneaky, lets do it <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
Bad thing about this contract is that selling / delivery point is Pop's Market which is literally the other side of the terrain, oh boy that will be a lot of driving back and forth <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-04-27T22:14:14Z Started to harvest... not contract but my own very first field! F253 soybeans <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>

<p>
But oh no, when combine header hit the crop... game told me this tool is whatever meant for contracts or something, so yeah now I remember I cannot use contract vehicle for my own field, there is somekind of check for those. Damn <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Alright so now I have to lease combine and grain trailer to haul the grain <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-04-27T22:54:02Z Started fertilizing F274, contract, GPS <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
<i>Edit: and there you have it, this savegame is now ruined by cheating, this goes against <a href="https://www.pmctactical.org/forum/viewtopic.php?f=76&t=22739" target="_blank">Start From Zero - Getting Started and Rules</a>, I do not own land yet, I am not allowed to use GPS just by owning a vehicle, man do I suck!</i> <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
<i>Edit: I'm trying to think of a non-excuse reason to keep this savegame alive, to be able to continue it, but unfortunately there is none. Yeah in the end I had over 3 million money (at the time of reading / writing this paragraph) so I could do some severe penalty like lets say -2,000,000 dollar fine for violating Start From Zero rules, just so I wouldn't need to delete yet another savegame and start all over again because honestly even though I love Start From Zero's the beginning part, I've now done it so many times my eyes bleed for all of those beginnings. But yeah, excuses are like assholes, everyone's got one... so there is no other option than to delete this savegame and start yet another one from the beginning this time properly do it without cheating (automated tools like GPS). What can you do, life sucks when you're stupid...</i> <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Aaahhh GuidanceSteering! My old friend <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
But, dunno, maybe its just wicked coincidence... <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-start-from-zero-pmc-iowa-garden-city-8km-2022-04-25-unofficial-004.php">next page</a>, <a href="stories-from-zero-iowa-garden-city-2022-04-25-unofficial.php">Start From Zero PMC Iowa Garden City 8km 2022-04-25 Unofficial Home</a>, go back to <a href="stories-start-from-zero-pmc-iowa-garden-city-8km-2022-04-25-unofficial-002.php">previous page</a>.
</p>
