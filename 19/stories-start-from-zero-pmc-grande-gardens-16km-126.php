...
Please read the background idea for <a href="stories.php">our Farming Simulator 19 Stories</a> so you understand what is this all about.
	...
	<h2>2024-01-20 Soybeans Planting Season Continues</h2>
...
<p>
Nice and quick field work course to kickstart this farming day <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Ahh first field planted for today <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
But now there is a problem, this F151 shape is just stupid, its like a long field in W-E direction with extremely narrow center part with large W and E ends, it kind of reminds me of a dumbbell that you lift in the gym, those hand weights. Dunno what was I thinking painting this field shape in GIMP, clearly I wasn't <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Then sent first big bud 747 to F59 E. Autodrive duration about 15min, in these kind of traveling situations you really start to appreciate the large scale farming nature of this terrain, you don't see this long driving durations in little girlie men terrains <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
Big field <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2024-01-20T12:19:25Z Yup I knew it, when I turned monitor back on big bud 747's were playing chicken, face to face, collision, CRASH BOOM BANG! <img src="../images/smileys/icon_evil.gif" alt="Smiley :evil:" loading="lazy">
</p>
...
<p>
Aayeah, soybeans planting season is over! <img src="../images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
<p>
Now I just need to figure out where is the road train grain trailer tipper/6 from this temporary seed truck, hmm, its somewhere in S-SE but where exactly... <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
How come I cant remember these details even though its mere month or so away (if even that?) when I played FS19 a lot, hmph <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>

<p>
Now I will not play anymore small little girlie men terrains, everything has to be 3km or larger so I get used to the big boy stuff <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
During next days seasons game sync dialog, green plants changed to green with white flowers, another field stage switch. But I'd say about time as its now soybeans harvest season already, huh!? <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
2024-01-20T15:43:57Z Okay waited for 5+ minutes, green plants with white flowers on the field, but the stage did change to darker color in ESC mapview, so something did happen. Anyways, more time accelerating and then I'll see what happens <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Hmm this doesn't look very good to me... <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
In-game 1640hrs crop / soil is dry, harvest is a go. Weather forecast predicts overcast skies for today and tomorrow, so even though it will be tight, I see no reason I couldn't get these fields harvested <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Whoah two hours and six minutes, for real? <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
I have to admit, two vehicles under courseplay and two under autodrive, FS19 performance is <i>extremely</i> bad, I don't even dare to bring up FPS counter as I can just see the stutter on the screen, its below 30FPS for sure <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
<i>Edit: later I checked FPS counter, it was sad depressing 20FPS at one point with all the vehicles in autodrive / courseplay control. Dunno man, that is basically unplayable levels, really bad stuff...</i> <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Got tired of waiting <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
First and second claas lexion 8900 collided after headland, sigh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2024-01-20T16:56:33Z And now second lexion collided with a high voltage power tower, sigh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2024-01-20T17:04:51Z My memory is coming back, these diagonal courseplay field work courses are the worst, its almost like not even worth trying to run because vehicles do a large loop outside the field on those diagonal turns, they do not respect "turn in field" or whatever the option was, not at all, vehicles go so way beyond field edges its not even funny. Yeah I am not going to do anymore diagonal field work courses, they are complete shit <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2024-01-20T17:15:39Z Collision, 4th lexion collided with railroad depot <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2024-01-20T17:19:17Z Collision, 1st combine collided with pine trees and now I have no fucking idea which course path / lane this one belongs to, sigh sigh sigh! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2024-01-20T17:23:52Z Collision, 4th lexion collided with pine trees <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
On every fucking turn these motherfuckers collide with something, I'm '' this close to calling it quits for today <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2024-01-20T17:26:22Z Just finished untangling 4th combine when courseplay notifications already come about the next bitch who is slipping and whatnot, NNNNGGGHH! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2024-01-20T17:30:31Z Now 1st lexion forgot that its field work course is on multiple tools convoy, it treated the course as a single vehicle, had to delete it and copy from another vehicle to have the left / right option appear, sigh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Why am I still playing this shit? <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2024-01-20T17:31:37Z 2nd lexion was out in the boonies collided with a train, sigh <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2024-01-20T17:33:34Z 3rd lexion collided with a train, sigh! <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2024-01-20T17:35:29Z 1st, 2nd, 3rd and 4th combines have collided with something (well OK I was driving 3rd but it still counts). Why, I'm asking simply... <i>why</i> <img src="../images/smileys/icon_confused.gif" alt="Smiley :?" loading="lazy">
</p>
...
<p>
Uuuaah <img src="../images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-start-from-zero-pmc-grande-gardens-16km-127.php">next page</a>, <a href="stories-from-zero-grande-gardens.php">Start From Zero PMC Grande Gardens 16km Home</a>, go back to <a href="stories-start-from-zero-pmc-grande-gardens-16km-125.php">previous page</a>.
</p>
