...
Please read the background idea for <a href="stories.php">our Farming Simulator 19 Stories</a> so you understand what is this all about.
	...
	<h2>2022-07-14 Seeding Soybeans</h2>
...
<p>
Copied FS19_AutoDrive.zip to C:\FS19.Mods\Start_From_Zero_PMC_Grande_Gardens_16km\ dir. Then copied from savegame14 dir AutoDrive_config.xml and AutoDriveUsersData.xml files into savegame1 dir. Now I should be set with autodrive and the routes I recorded earlier.
</p>
...
<p>
Took a screenshot of current fields in growth menu, saved it under PMC-Grande-Gardens-Start-From-Zero-PDA-Map-2022-07-14T0555.png file name and moved to PMC DevSurf. <i>Edit: 2024-02-07T14:03:00Z, well I cant find this PNG today, no idea where I might have moved it, at least its not in the usual screenshots directories.</i>
</p>
...
<p>
SCREENSHOT PMCTODO PMC-Grande-Gardens-16km-Start-From-Zero-Harvests.jpg <!-- see above missing PNG image -->
</p>
...
<p>
So I must track all harvested fields now simply by COORDINATES, I paint green circle over all fields that I have harvested. This is somewhat cumbersome job as when harvest finishes I have to switch to PMC DevSurf computer to use GIMP and paint over the XCF image. Of course you are not finishing harvests every five minutes so it should not be a problem <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Ah fuck, I just cant remember <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
Lets just get it done, starting planting season now, starting to move big bud 747's with bourgault 3420-100 air drills towards F88 <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<a href="screenshots/PMC-Grande-Gardens-16km-2022-07-14T0714.jpg" target="_blank"><img src="screenshots/thumbs/PMC-Grande-Gardens-16km-2022-07-14T0714.jpg" class="terrainimg" loading="lazy" alt="Start From Zero PMC Grande Gardens 16km Farming Simulator 19 Screenshot"></a>
...
<p>
Here I go, first planting for this season and farming gaming session, good to be back in FS19 and PMC Grande Gardens 16km! <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
When I came back from the kitchen... of course the leading big bud collided with a vehicle shed building, heh. Had to untangle those so I can eat in peace without stressing over wasting time while tractor is stuck in a building <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
2022-07-14T08:12:16Z Feeding time over, back to grande gardens <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<a href="screenshots/PMC-Grande-Gardens-16km-2022-07-14T0831.jpg" target="_blank"><img src="screenshots/thumbs/PMC-Grande-Gardens-16km-2022-07-14T0831.jpg" class="terrainimg" loading="lazy" alt="Start From Zero PMC Grande Gardens 16km Farming Simulator 19 Screenshot"></a>

<p>
Great to be seeding another field in FS19 <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
This was going so great that now the extreme east edge fields are tempting me, F138-F140 could be done with a single bourgault air drill per field, hmm perhaps not F138 as its semi large, I'll see. After those fields were done it might be enough for this planting season, I'll have to see what time is it when they are done. One field at the time <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<p>
That was fast, heh lets do more <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>
...
<a href="screenshots/PMC-Grande-Gardens-16km-2022-07-14T0911.jpg" target="_blank"><img src="screenshots/thumbs/PMC-Grande-Gardens-16km-2022-07-14T0911.jpg" class="terrainimg" loading="lazy" alt="Start From Zero PMC Grande Gardens 16km Farming Simulator 19 Screenshot"></a>
...
<p>
2022-07-14T12:21:29Z Both bourgaulr air cart's are below 30% tank capacity, heh good thing I brougth full 70k trailer load of seeds <img src="../images/smileys/icon_wink.gif" alt="Smiley ;)" loading="lazy">
</p>

<p>
2022-07-14T12:25:52Z Second big bud reached end of field work course, heh. Okay lets go finish up those missed spots <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2022-07-14T14:21:41Z Finally finished autodrive semi-truck grain trailer unloading route recording and setting up, took way too long, got frustrated how long it took <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Setup combine harvester courseplay field work course, started it and ... FS19 froze, as usual. Oh man do I hate courseplay freezing shit <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
Oh well with experience I've learned always to save game before starting large courseplay course, so task manager kill farmsimgame and lets restart <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
2022-07-14T14:35:03Z Attempted to start harvesing, generated courseplay course, started it now with "first waypoint" option, still freezes. Okay so its the longest edge that fucks it up, I have to drive my fucken harvesters all the way to the short ends (north or south), sigh. Alright another task manager kill and restart, sigh... maybe I should have go to play some Elite Dangerous <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<a href="screenshots/PMC-Grande-Gardens-16km-2022-07-14T1501.jpg" target="_blank"><img src="screenshots/thumbs/PMC-Grande-Gardens-16km-2022-07-14T1501.jpg" class="terrainimg" loading="lazy" alt="Start From Zero PMC Grande Gardens 16km Farming Simulator 19 Screenshot"></a>

<p>
Wait for me!
</p>

<a href="screenshots/PMC-Grande-Gardens-16km-2022-07-14T1503.jpg" target="_blank"><img src="screenshots/thumbs/PMC-Grande-Gardens-16km-2022-07-14T1503.jpg" class="terrainimg" loading="lazy" alt="Start From Zero PMC Grande Gardens 16km Farming Simulator 19 Screenshot"></a>
...
<p>
But yeah gets the job done, four midwest durus 18.2m headers cutting a field, good progress <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
2022-07-14T16:22:20Z What an irony, JUST as I finished writing the first paragraph... there is several minutes downtime when courseplay four harvesters go into the useless empty headland loop <img src="../images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Was watching Elite Dangerous twitch live stream while harvesters did that empty loop, it took over 10 minutes <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2022-07-14T17:26:57Z This shit is so slow that one human player with GPS would probably done the field this far quicker <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>

<p>
It is just insane how long winded useless detours these harvesters do outside the field edges, they drive 10km/h and that speed cannot even be adjusted, just so fucking stupid <img src="../images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
Continue reading <a href="stories-start-from-zero-pmc-grande-gardens-16km-123.php">next page</a>, <a href="stories-from-zero-grande-gardens.php">Start From Zero PMC Grande Gardens 16km Home</a>, go back to <a href="stories-start-from-zero-pmc-grande-gardens-16km-121.php">previous page</a>.
</p>
