...
<h1><b>User Guide: Cornbelt - PMC Farming Simulator</b></h1>
</header>

<section>

	<h2>Basic User Guide for Cornbelt Map / Terrain</h2>
...
<p>
Fertilizer / Seed silo capacity at your farm connected to the rail road tracks has 1 million liter capacity <b>per type</b>, so you can store 1 million liters of fertilizer and 1 million liters of seed.
</p>
...
Seed factory product (seeds) capacity is 350,000 liters.
	...
	<h2>Howto Use Cornbelt Seed and Fertilizer Factory</h2>

<p>
Quick overview:<br>
Wheat and water == seeds<br>
Crude oil and soybeans / sunflowers / canola == fuel and compost<br>
...
btw you get slurry from HQ, umm somewhere there heh
	...
	<h2>Howto Use Cornbelt Refinery</h2>
...
<p>
<b>Quick summary - HOWTO make fuel for vehicles</b><br>
1) Pickup crude oil with a tanker truck from the oil fields<br>
2) Drop off crude oil with a tanker truck to railroad petrol stations (one example south of Mary's Farm). Crude oil will transfer from train side over time (several minutes).<br>
3) Pickup crude oil with a train tanker cars from petrol stations<br>
4) Drop off crude oil with a train tanker cars to Stanton Sawmill refinery<br>
5) Truck dump soybeans or canola or sunflower into right next to the train crude oil unload point<br>
Now if you get out of your truck to walk next to the tipping point, your F1 menu will show statistics about fuel and compost being produced. Optionally you should haul this refined fuel into the fuel stations across the terrain.
	...
	<h2>Howto Use Cornbelt Sawmill</h2>
...
<p>
Field ID, Hectares, Cost (millions)<br>
01, 124, 10<br>
02, 48, 3.9<br>
03, 54, 4.4<br>
04, 51, 4.1<br>
...
There are 4 trains in this terrain and they are usable for players (make sure your in-game options allow TAB to trains or you have to walk up to the train and hit E otherwise).
	...
	<h2>Manure, Slurry Purchasing</h2>
