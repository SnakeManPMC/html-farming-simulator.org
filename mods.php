...
<li>Commodity Prices, ZZZ_CommodityPrices</li>
<li>Courseplay</li>
<li>Free Camera</li>
...
<p>New equipment is kind of like "why not", good to have more options. Not so sure about maps / terrains, the initial impression to them was bad, they looked shitty poor quality.
</p>

	<h2>PMC Tested Generic Mods</h2>

<h2>Money Tool, FS17_MoneyTool</h2>
<p>
Works OK! Will be definitely useful when testing those new DLC and mods which have expensive stuff, otherwise... using this tool is moot point, why cheat? whats the point of playing like that? Also Creator Tools has one billion money cheat feature.
</p>
...
<br><br>
<a href="https://www.youtube.com/watch?v=LogtkWJ7M04">GPS Mod Video Tutorial</a>
</p>
...
<p>
Makes one vehicle follow another. I'd say use courseplay instead.
</p>
...
<p>
Use CTRL-E to bring up the menu and then up and down arrows to move between different groups, left and right arrows to move position inside the current group. To choose the groups use CTRL-GROUPNUMBER and then you can repeat to switch across the vehicles in this group.
</p>
...
<p>
When you walk up next to your vehicle this mod offers you option to repair it instantly, it costs but still you dont have to drive the vehicle to the repair shop. Repairing a vehicle will remove its excessive and stupid daily running costs. However, you have to repair your vehicles any time you walk by them to have any point using this mod.
</p>
...
<h2>Terrains.Required_Mods\B_Krone_Beastpack_1100_by_Bullgore</h2>
...
<p>
Time accelleration or time scale, speeding up time. It uses simple keyboard shortcut to increase game speed to 12000x (default unmodded is only up to 120x). Time accelleration only works outside vehicles, which limits you accidentally activating it.
</p>

<h2>Bromar MBT 150, FS17Contest_Bromar_MBT150</h2>

<p>
<a href="http://www.bromarengineering.com.au/products/mother-bin">Realistic but insane auger wagon or "chaser bin"</a>, it holds incredible 185,000 liters if crop and supports all kinds of crops even some custom made ones. Tractor with 209 horsepower seems to pull <i>empty</i> wagon just fine.
</p>

<h2>TM_JohnDeere_8R</h2>

<p>
</p>

<h2>JohnDeere_9R_V2</h2>
